namespace MyCMS.Servicelayer.EFServices.Enums
{
    ...
    public enum UpdateCurrencyStatus
    {
        Successfull,
        Faild
    }

    public enum UpdateSliderStatus
    {
        Successfull,
        Faild
    }
