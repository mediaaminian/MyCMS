...
namespace MyCMS.Web.Areas.Admin.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CategoryController : MyCMS.Web.Areas.Admin.Controllers.CategoryController
    {
        ...
        [NonAction]
        partial void DataTableOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string term, int page, int count, MyCMS.Servicelayer.EFServices.Enums.Order order, MyCMS.Servicelayer.EFServices.Enums.CategoryOrderBy orderBy, MyCMS.Servicelayer.EFServices.Enums.CategorySearchBy searchBy);

        [NonAction]
        public override System.Web.Mvc.ActionResult DataTable(string term, int page, int count, MyCMS.Servicelayer.EFServices.Enums.Order order, MyCMS.Servicelayer.EFServices.Enums.CategoryOrderBy orderBy, MyCMS.Servicelayer.EFServices.Enums.CategorySearchBy searchBy)
        {
        ...
        [NonAction]
        partial void AddOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MyCMS.DomainClasses.Entities.Category category);
