...
namespace MyCMS.Web.Areas.Admin.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_PostController : MyCMS.Web.Areas.Admin.Controllers.PostController
    {
        ...
        [NonAction]
        partial void AddPostOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MyCMS.Model.AdminModel.AddPostModel postModel);

        [NonAction]
        public override System.Web.Mvc.ActionResult AddPost(MyCMS.Model.AdminModel.AddPostModel postModel)
        {
        ...
        [NonAction]
        partial void EditPostOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MyCMS.Model.AdminModel.EditPostModel postModel);

        [NonAction]
        public override System.Web.Mvc.ActionResult EditPost(MyCMS.Model.AdminModel.EditPostModel postModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.EditPost);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "postModel", postModel);
