var Login = function() {
    ...
    return { init: function() { r(), $(".login-bg").backstretch(["/Content/Admin/css/images/bg1.jpg", "/Content/Admin/css/images/bg2.jpg", "/Content/Admin/css/images/bg3.jpg"], { fade: 1e3, duration: 8e3 }), $(".forget-form").hide() } }
}();
