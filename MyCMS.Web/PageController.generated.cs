...
namespace MyCMS.Web.Controllers
{
    public partial class PageController
    {
        ...
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public virtual System.Web.Mvc.ActionResult IndexWithKeyWord()
        {
            return new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.IndexWithKeyWord);
        }
        [NonAction]
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        ...
        public class ActionNamesClass
        {
            ...
            public readonly string IndexWithKeyWord = "IndexWithKeyWord";
        ...
        public class ActionNameConstants
        {
            ...
            public const string IndexWithKeyWord = "IndexWithKeyWord";
        ...
        static readonly ActionParamsClass_IndexWithKeyWord s_params_IndexWithKeyWord = new ActionParamsClass_IndexWithKeyWord();
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ActionParamsClass_IndexWithKeyWord IndexWithKeyWordParams { get { return s_params_IndexWithKeyWord; } }
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public class ActionParamsClass_IndexWithKeyWord
        {
        ...
        public class ViewsClass
        {
            ...
            public readonly string IndexWithKeyWord = "~/Views/Page/IndexWithKeyWord.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_PageController : MyCMS.Web.Controllers.PageController
    {
        ...
        [NonAction]
        partial void IndexWithKeyWordOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string keyword);

        [NonAction]
        public override System.Web.Mvc.ActionResult IndexWithKeyWord(string keyword)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.IndexWithKeyWord);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "keyword", keyword);
            IndexWithKeyWordOverride(callInfo, keyword);
            return callInfo;
        }
