...
namespace MyCMS.Web.Infrastructure
{
    public class ViewConvertor : Controller, IViewConvertor
    {
        ...
        public string RenderRazorViewToString(string viewName, object model)
        {
            ...
            {
                var viewResult = ViewEngines.Engines.FindPartialView(CreateController<MyCMSController>().ControllerContext ,viewName);
                var viewContext = new ViewContext(CreateController<MyCMSController>().ControllerContext, viewResult.View,
