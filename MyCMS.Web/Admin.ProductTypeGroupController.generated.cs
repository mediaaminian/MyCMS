...
{
    public partial class ProductTypeGroupController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected ProductTypeGroupController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public ProductTypeGroupController Actions { get { return MVC.Admin.ProductTypeGroup; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Admin";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "ProductTypeGroup";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "ProductTypeGroup";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string _DataTable = "~/Areas/Admin/Views/ProductTypeGroup/_DataTable.cshtml";
            public readonly string _Index = "~/Areas/Admin/Views/ProductTypeGroup/_Index.cshtml";
            static readonly _EditorTemplatesClass s_EditorTemplates = new _EditorTemplatesClass();
            public _EditorTemplatesClass EditorTemplates { get { return s_EditorTemplates; } }
            [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
            public partial class _EditorTemplatesClass
            {
                public readonly string ProductTypeGroup = "ProductTypeGroup";
            }
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_ProductTypeGroupController : MyCMS.Web.Areas.Admin.Controllers.ProductTypeGroupController
    {
        public T4MVC_ProductTypeGroupController() : base(Dummy.Instance) { }
