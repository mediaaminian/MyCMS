...
namespace MyCMS.Web.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_SearchController : MyCMS.Web.Controllers.SearchController
    {
        public T4MVC_SearchController() : base(Dummy.Instance) { }

        [NonAction]
        partial void IndexOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string term, int page, int count);

        [NonAction]
        public override System.Web.Mvc.ActionResult Index(string term, int page, int count)
        {
            ...
            IndexOverride(callInfo, term, page, count);
            return callInfo;
        }
