...
{
    public partial class TimeFrameController
    {
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        protected TimeFrameController(Dummy d) { }
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public TimeFrameController Actions { get { return MVC.Admin.TimeFrame; } }
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Area = "Admin";
        [GeneratedCode("T4MVC", "2.0")]
        public readonly string Name = "TimeFrame";
        [GeneratedCode("T4MVC", "2.0")]
        public const string NameConst = "TimeFrame";
        [GeneratedCode("T4MVC", "2.0")]
        ...
        public class ViewsClass
        {
            ...
            public readonly string _DataTable = "~/Areas/Admin/Views/TimeFrame/_DataTable.cshtml";
            public readonly string _Index = "~/Areas/Admin/Views/TimeFrame/_Index.cshtml";
            static readonly _EditorTemplatesClass s_EditorTemplates = new _EditorTemplatesClass();
            public _EditorTemplatesClass EditorTemplates { get { return s_EditorTemplates; } }
            [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
            public partial class _EditorTemplatesClass
            {
                public readonly string TimeFrame = "TimeFrame";
            }
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_TimeFrameController : MyCMS.Web.Areas.Admin.Controllers.TimeFrameController
    {
        public T4MVC_TimeFrameController() : base(Dummy.Instance) { }
