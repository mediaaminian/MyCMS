...
namespace MyCMS.Web.Areas.Admin.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CommentController : MyCMS.Web.Areas.Admin.Controllers.CommentController
    {
        ...
        [NonAction]
        partial void DataTableOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string term, int page, int count, MyCMS.Servicelayer.EFServices.Enums.Order order, MyCMS.Servicelayer.EFServices.Enums.CommentOrderBy orderBy, MyCMS.Servicelayer.EFServices.Enums.CommentSearchBy searchBy);

        [NonAction]
        public override System.Web.Mvc.ActionResult DataTable(string term, int page, int count, MyCMS.Servicelayer.EFServices.Enums.Order order, MyCMS.Servicelayer.EFServices.Enums.CommentOrderBy orderBy, MyCMS.Servicelayer.EFServices.Enums.CommentSearchBy searchBy)
        {
        ...
        [NonAction]
        partial void AutoCompleteSearchOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string term, MyCMS.Servicelayer.EFServices.Enums.CommentSearchBy searchBy);

        [NonAction]
        public override System.Web.Mvc.ActionResult AutoCompleteSearch(string term, MyCMS.Servicelayer.EFServices.Enums.CommentSearchBy searchBy)
        {
