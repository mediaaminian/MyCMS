...
return array(
	...
	'Duplicate' => 'تکرار فایل',
	'Folders' => 'پوشه ها',
	'Copy' => 'کپی',
	'Cut' => 'برش',
	'Paste' => 'چسباندن',
	'CB' => 'clipboard', // clipboard
	'Paste_Here' => 'چسباندن در این مسیر',
	'Paste_Confirm' => 'آیا از چسباندن این فایل در این پوشه مطمئن هستید؟ فایل های همنام جایگزین خواهند شد',
	'Paste_Failed' => 'عدم موفقیت در چسباندن فایل',
	'Clear_Clipboard' => 'خالی کردن حافظه کپی',
	'Clear_Clipboard_Confirm' => 'آیا مطمئن هستید میخواید حافظه کپی را خالی نمایید?',
	'Files_ON_Clipboard' => 'هیچ فایلی در حافظه کپی وجود ندارد.',
	'Copy_Cut_Size_Limit' => 'فایل ها/پوشه های انتخاب شده برای کپی و یا برش بسیار  بزرک هستند %s. محدودیت: %d MB/برای عملیات', // %s = برش و یا کپی
	'Copy_Cut_Count_Limit' => 'تعداد فایل ها/پوشه ها بسیار زیاد میباشد %s. محدودیت: %d فایل/عملیات', // %s = برش و یا چسباندن
	...
	'Valid_Extensions' => 'پسوند های مجاز: %s', // %s = txt,log مانند.
