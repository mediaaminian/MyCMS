...
<!-- header div end -->
	...
	?>
	<li class="pull-right" style="display:none" ><a class="btn-small" href="javascript:void('')" id="info"><i class="icon-question-sign"></i></a></li>
	<li class="pull-right" style="display:none" ><a class="btn-small" href="javascript:void('')" id="change_lang_btn"><i class="icon-globe"></i></a></li>
