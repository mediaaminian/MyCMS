...
namespace MyCMS.Web.Areas.Admin.Controllers
{
    ...
    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_PageController : MyCMS.Web.Areas.Admin.Controllers.PageController
    {
        ...
        [NonAction]
        partial void AddOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MyCMS.Model.AdminModel.AddPageModel pageModel);

        [NonAction]
        public override System.Web.Mvc.ActionResult Add(MyCMS.Model.AdminModel.AddPageModel pageModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Add);
        ...
        [NonAction]
        partial void DataTableOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, string term, int page, int count, MyCMS.Servicelayer.EFServices.Enums.Order order, MyCMS.Servicelayer.EFServices.Enums.PageOrderBy orderBy, MyCMS.Servicelayer.EFServices.Enums.PageSearchBy searchBy);

        [NonAction]
        public override System.Web.Mvc.ActionResult DataTable(string term, int page, int count, MyCMS.Servicelayer.EFServices.Enums.Order order, MyCMS.Servicelayer.EFServices.Enums.PageOrderBy orderBy, MyCMS.Servicelayer.EFServices.Enums.PageSearchBy searchBy)
        {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, MyCMS.Model.AdminModel.EditPageModel pageModel);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(MyCMS.Model.AdminModel.EditPageModel pageModel)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "pageModel", pageModel);
