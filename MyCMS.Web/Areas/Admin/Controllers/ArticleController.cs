...
namespace MyCMS.Web.Areas.Admin.Controllers
{
    ...
    public partial class ArticleController : Controller
    {
        ...
        public virtual ActionResult ConfirmDelete(int id)
        {
            ...
            ViewBag.Id = id;
            ViewBag.EntityName = "مقاله";
            ViewBag.DeleteActionName = MVC.Admin.Article.ActionNames.Delete;
            ViewBag.ControllerName = MVC.Admin.Article.Name;
            ViewBag.ReturnActionName = MVC.Admin.Article.ActionNames.Index;
