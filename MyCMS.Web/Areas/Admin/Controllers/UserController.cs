    ...
    public partial class UserController : Controller
    {
            ...
            UserSearchBy searchBy = UserSearchBy.UserName)
        {
            ...
            IList<UserDataTableModel> selectedUsers = _userService.GetDataTable(term, page, count, order, orderBy,
                searchBy).Where(u => u.IsBaned != null && !(bool)(u.IsBaned)).ToList();
            ...
            var selectListOrderBy = new List<SelectListItem>
            {
                ...
                new SelectListItem {Value = "PostCount", Text = "تعداد دانشنامه"},
        ...
        public virtual ActionResult ConfirmDelete(int id)
        {
            ...
            if (userId == id)
            {
                return PartialView(MVC.Admin.Shared.Views._Alert, new Alert { Mode = AlertMode.Error, Message = "شما نمیتوانید کاربر جاری را حذف نمایید!" });
            }

            ViewBag.Id = id;
            ViewBag.EntityName = "کاربر";
            ViewBag.DeleteActionName = MVC.Admin.User.ActionNames.Delete;
            ViewBag.ControllerName = MVC.Admin.User.Name;
            ViewBag.ReturnActionName = MVC.Admin.User.ActionNames.Index;
        ...
        public virtual ActionResult Delete(int id)
        {
            ...
            _uow.SaveChanges();
            return PartialView(MVC.Admin.Shared.Views._Alert, new Alert { Message = "کاربر مورد نظر با موفقیت حذف شد" });
        }
