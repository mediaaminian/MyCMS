    ...
    public partial class LabelController : Controller
    {
            ...
            LabelSearchBy searchBy = LabelSearchBy.Name)
        {
            ...
            var selectListOrderBy = new List<SelectListItem>
            {
                ...
                new SelectListItem {Text = "تعداد دانشنامه ها", Value = "PostCount"}
            };
        ...
        {
            ViewBag.Id = id;
            ViewBag.EntityName = "برچسب";
            ViewBag.DeleteActionName = MVC.Admin.Label.ActionNames.Delete;
            ViewBag.ControllerName = MVC.Admin.Label.Name;
            ViewBag.ReturnActionName = MVC.Admin.Label.ActionNames.Index;
