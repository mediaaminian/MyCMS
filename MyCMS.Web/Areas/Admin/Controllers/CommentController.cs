...
namespace MyCMS.Web.Areas.Admin.Controllers
{
    ...
    public partial class CommentController : Controller
    {
        ...
        {
            ViewBag.Id = id;
            ViewBag.EntityName = "کامنت";
            ViewBag.DeleteActionName = MVC.Admin.Comment.ActionNames.Delete;
            ViewBag.ControllerName = MVC.Admin.Comment.Name;
            ViewBag.ReturnActionName = MVC.Admin.Comment.ActionNames.Index;
