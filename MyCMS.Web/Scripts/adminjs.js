...
function loadFroala(selector, option) {
    var options = {
        ...
        //saveURL: '@Url.Action("FroalaAutoSave", "File")',
        //saveParams: { postId: "123" },
        spellcheck: true,
        plainPaste: true,
        imageButtons: ["removeImage", "replaceImage", "linkImage"],
        borderColor: '#00008b',
        imageUploadURL: '/File/FroalaUploadImage',
        //imageParams: { postId: "123" },
        fileUploadURL: '/File/FroalaUploadFile',
        //fileParams: { postId: "123" },
        enableScript: true,
        theme: 'dark'
    };
...
function loadRedactor(selector, option) {
    var options = { direction: 'rtl', autoresize: false, autoformat: false, convertDivs: false };
    $.extend(options, option);
