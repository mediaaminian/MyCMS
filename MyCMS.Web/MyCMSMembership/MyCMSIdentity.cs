...
{
    public class MyCMSIdentity : IIdentity
    {
        public MyCMSIdentity(FormsAuthenticationTicket ticket)
        {
            if (ticket == null)
            {
                Name = "Guest";
            ...
            var data = JsonConvert.DeserializeObject<MyCMSCookie>(ticket.UserData);
        ...
        public MyCMSIdentity(User user)
        {
            if (user == null)
            {
                AsGuest();
